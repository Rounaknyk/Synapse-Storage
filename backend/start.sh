...
cd "/Users/rounaknaik/nextProjects/Synapse Storage/Synapse-Storage/backend" && python3 -m venv venv && source venv/bin/activate && pip install -r requirements.txt 2>&1


cd "/Users/rounaknaik/nextProjects/Synapse Storage/Synapse-Storage/backend" && source venv/bin/activate && uvicorn main:app --reload --host 0.0.0.0 --port 8000 2>&1